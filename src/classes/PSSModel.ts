          ...
          for (const taskData of fileData) {
            ...
            switch (Type) {
              ...
              case "Cancellation":
                ...
                // If result is not true, throw an error
                if (result !== true) {
                  throw new Error(result);
                }
              ...
              case "Appointment":
                ...
                break;
              default:
                // Log error if task type not recognized
